...
const previewVariantButtons = [
  ...
  { value: 'simplified', label: 'No actions' },
]
...
<template>
  <main class="review-changes-page">
    ...
    <header class="review-changes-page__header">
      <RouterLink to="/template-dashboard-testing08" class="review-changes-page__back" aria-label="Back to dashboard">
    ...
    <section class="review-changes-page__list" aria-label="Suggested changes to review">
      <div class="review-changes-page__variant">
        <span id="preview-style-label">Preview style</span>
        <CdxToggleButtonGroup
          v-model="previewVariant"
          :buttons="previewVariantButtons"
